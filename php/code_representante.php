...
<?php
    ...
    }else
    {
                ...
                $sqls = "SELECT code FROM code_representante_Diurna WHERE code = '$code'";
                ...
                if($row == null)
                {
                    $sqlsm = "SELECT code FROM code_representante_Mixta WHERE code = '$code'";
                    ...
                    if($rowm == null)
                    {
                        $sqlsm = "SELECT code FROM code_representante_Nocturna WHERE code = '$code'";
