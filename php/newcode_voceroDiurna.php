...
<?php
    ...
    }else
    {
                    ...
                    $sqlvd = "SELECT * FROM newcode_vocero_Diurna";
                    ...
                    if($rowvd == null)
                    {
                        $sqlivs = "INSERT INTO newcode_vocero_Diurna(code)VALUES('$code')";
                        
                            $queryivd=sqlsrv_query($conn,$sqlivs);
                
                            if($queryivd){

                                $sqlsvd = "SELECT code FROM newcode_vocero_Diurna";
                    ...
                    {
                        $sqllos = "UPDATE newcode_vocero_Diurna set code = '$code'";
                        
                            $queryuvd=sqlsrv_query($conn,$sqllos);
                
                            if($queryuvd){

                                $sqllov = "SELECT code FROM newcode_vocero_Diurna";
