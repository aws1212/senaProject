...
<?php
    ...
    {
        $sqlvd = "SELECT * FROM newcode_vocero_Mixta";
        ...
        if($rowvd == null)
        {
            $sqlivs = "INSERT INTO newcode_vocero_Mixta(code)VALUES('$code')";
            
                $queryivd=sqlsrv_query($conn,$sqlivs);
    
                if($queryivd){

                    $sqlsvd = "SELECT code FROM newcode_vocero_Mixta";
        ...
        {
            $sqllos = "UPDATE newcode_vocero_Mixta set code = '$code'";
            
                $queryuvd=sqlsrv_query($conn,$sqllos);
    
                if($queryuvd){

                    $sqllov = "SELECT code FROM newcode_vocero_Mixta";
